...
const { uploadReports, manageArchiveRetention } = require('./archiveManager');
...
exports.handler = async (event, context) => {
    ...
    try {
        ...
        const normalizedData = {
            ...
            regions: regions,
            services: services,
            servicesByRegion: servicesByRegion
        };
        ...
        // Step 5: Manage archive retention (non-critical)
        ...
        const successMetrics = {
            ...
            serviceMappingCount: servicesByRegion ?
                Object.keys(servicesByRegion).reduce((acc, region) =>
                    acc + (servicesByRegion[region]?.length || 0), 0) : 0,
